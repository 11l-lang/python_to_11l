        ...
        if len(self.children) == 1:
            ...
            if self.symbol.id == '.':
                ...
                if self.children[0].scope_prefix == ':::':
                    ...
                    'random:random': 'random:', 'fractions:Fraction': 'Fraction', 'csv:reader': 'csv:readf', 'csv:DictReader': 'csv:readf', 'csv:writer': 'csv:WriterF'}.get(r, r)
...
class ASTException(ASTNodeWithExpression):
    ...
    def to_str(self, indent):
        return self.pre_nl + ' ' * (indent*3) + 'X ' + self.expression.to_str() + "\n"
